            ...
            <div class="col">
               <div class="page-header-left">
                  ...
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item">Mollie</li>
                           ...
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="card-box">
                                    ...
                                    <form action="{{url('admin/payment_gateway/mollie')}}" method="post"
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-8">
                                             <input type="text" name="mollie_api_key"
                                                value="{{ isset($gateway_info->mollie_api_key) ? stripslashes($gateway_info->mollie_api_key) : null }}"
                                                class="form-control">
                                          </div>
                                       </div><br>
