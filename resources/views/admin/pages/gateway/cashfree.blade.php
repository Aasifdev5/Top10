            ...
            <div class="col">
               <div class="page-header-left">
                  ...
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item">Cashfree</li>
                           ...
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="card-box">
                                    ...
                                    <form action="{{url('payment_gateway/cashfree')}}" method="post" enctype="multipart/form-data">
                                       @csrf
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-8">
                                             <select class="form-control" name="mode">
                                                <option value="sandbox" @if(isset($gateway_info) AND $gateway_info->
                                                   mode=="sandbox")
                                                   selected @endif>Sandbox</option>
                                                <option value="live" @if(isset($gateway_info) AND $gateway_info->
                                                   mode=="live")
                                       ...
                                       <div class="form-group row">
                                          <label class="col-sm-3 col-form-label">Cashfree Secret
                                             Key</label>
                                          <div class="col-sm-8">
