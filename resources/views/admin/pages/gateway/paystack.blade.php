            ...
            <div class="col">
               <div class="page-header-left">
                  ...
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item">Paystack</li>
                           ...
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="card-box">
                                    ...
                                    <form action="{{url('admin/payment_gateway/paystack')}}" method="post"
                                       enctype="multipart/form-data">
                                       @csrf


                                       <input type="hidden" name="id"
                                          value="{{ isset($post_info->id) ? $post_info->id : null }}">
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-8">
                                             <input type="text" name="gateway_name"
                                                value="{{ isset($post_info->gateway_name) ? stripslashes($post_info->gateway_name) : null }}"
                                                class="form-control">
                                          </div>
                                       </div><br>

                                       <div class="form-group row">
                                          <label class="col-sm-3 col-form-label">Paystack Secret
                                             Id</label>
                                          <div class="col-sm-8">
                                             <input type="text" name="paystack_secret_key"
                                                value="{{ isset($gateway_info->paystack_secret_key) ? stripslashes($gateway_info->paystack_secret_key) : null }}"
                                                class="form-control">
                                          </div>
                                       </div><br>
                                       <div class="form-group row">
                                          <label class="col-sm-3 col-form-label">Paystack Public
                                             key</label>
                                          <div class="col-sm-8">
                                             <input type="text" name="paystack_public_key"
                                                value="{{ isset($gateway_info->paystack_public_key) ? stripslashes($gateway_info->paystack_public_key) : null }}"
                                                class="form-control">
                                          </div>
                                       </div>
                                       <br>
