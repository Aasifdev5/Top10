                            ...
                            <div class="breadcrumb__content__right">
                                <nav aria-label="breadcrumb">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a
                                                href="{{ route('subcategory.index') }}">{{ __('Subcategories') }}</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">{{ __('Add Subcategory') }}
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                            ...
                            <div class="card-body">
                                <form action="{{ route('subcategory.store') }}" method="post"
                                    ...
                                    <div class="input__group mb-25">
                                        ...
                                        @endif
                                        <p><span class="text-black">{{ __('Accepted Files') }}:</span> PNG, JPG <br> <span
                                                class="text-black">{{ __('Recommend Size') }}:</span> 1200 x 627</p>
                                    </div>
