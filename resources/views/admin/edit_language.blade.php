                                                                  ...
                                                                  <div class="personal-image">
                                                                     <label class="label">
                                                                        ...
                                                                        <figure class="personal-figure">
                                                                           @if(!empty($language->language_photo))
                                                                           <img src="{{asset('images/language/')}}<?php echo '/' . $language->language_photo; ?>" class="personal-avatar" alt="avatar" id="profileImagePreview">
                                                                           @else
