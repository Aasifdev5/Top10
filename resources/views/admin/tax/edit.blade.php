...
@section('content')
                                ...
                                <div class="form-vertical__item bg-style">
                                    ...
                                    <form id="Form">
                                        ...
                                        <div class="input__group mb-25">
                                            ...
                                            <div>
                                                <input type="text" name="title" id="name"
                                                    value="{{ $category->title }}" class="form-control flat-input"
                                                    >
                                                @if ($errors->has('title'))
                                        ...
                                        <div class="input__group mb-25">
                                            ...
                                            <input type="text" name="percentage" id="percentage" value="{{ old('percentage',$category->percentage) }}"
    ...
    <script>
        $('#Form').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('tax.update', [$category->id]) }}",
                data: formData,
                dataType: "json",
                ...
                error: function(xhr, status, error) {
                    ...
                    toastr.error("Failed to update tax. Please try again later.");
                }
            });
        });
    </script>
